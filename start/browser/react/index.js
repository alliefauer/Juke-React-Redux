...
import {receivePlaylists, getPlaylistById, loadAllSongs, loadAllSongsInGenre} from './action-creators/playlists';
...
//   store.displatch(loadAllSongsInGenre(nextRouterState.params.genreName));
// }
